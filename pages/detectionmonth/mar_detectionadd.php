<?php
	...
	if($conn->connect_error){
		...
		$stmt = $conn->prepare("insert into mar_detectiondata (dataid ,Day,Month,Year,Cyber_Attack_Details,Time,Status,Threat_Level,Description) values(?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<a href = "http://localhost/umpbcas2/pages/detectionmonth/mar_detectiondata.php"><button>Back </button></a>