      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="jan_detectionadd.php" method="POST">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="addcyberattackdetection.php" method="POST">
              ...
              <div class="form-group">
                <label for="Day">Day</label>
                <input type="text" class="form-control" id="Day" name="Day" placeholder="<?php echo $row['dataid'] ?>" />
              </div>

              <div class="form-group">
                <label for="Month">Month</label>
                <input type="text" class="form-control" id="Month" name="Month" placeholder="month OLD data from db" />
              </div>

              <div class="form-group">
                <label for="Year">Year</label>
                <input type="text" class="form-control" id="Year" name="Year" placeholder="year OLD data from db" />
              </div>
              <div class="form-group">
                <label for="Cyber_Attack_Details">Cyber_Attack_Details</label>
                <input type="text" class="form-control" id="Cyber_Attack_Details" name="Cyber_Attack_Details" placeholder="details OLD data from db" />
              </div>
              <div class="form-group">
                <label for="Time">Time</label>
                <input type="text" class="form-control" id="Time" name="Time" placeholder="time OLD data from db" />
              </div>
              <div class="form-group">
                <label for="Status">Status</label>
                <input type="text" class="form-control" id="Status" name="Status" placeholder="status OLD data from db" />
              </div>
              <div class="form-group">
                <label for="Threat_Level">Threat Level</label>
                <input type="text" class="form-control" id="Threat_Level" name="Threat_Level" placeholder="threatlevel OLD data from db" />
              </div>
              <div class="form-group">
                <label for="Description">Description</label>
                <input type="text" class="form-control" id="Description" name="Description" placeholder="description OLD data from db" />
              </div>
