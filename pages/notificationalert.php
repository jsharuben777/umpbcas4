  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="http://localhost/umpbcas2/pages/cyberattackdetection.php">Cyber Attack Detention Info</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/umpbcas2/pages/notificationalert.php" >Notification Alert</a>
        </li>
        <li class="nav-item">
...
<div class="alert alert-danger" role="alert">
  HTTP intrusion detected at 2311H <a href="http://127.0.0.1:8000/cyberattackdetectionpage" class="alert-link">Attack Data</a>. Click to view Cyber Attack information
</div>
<div id="wrapper">
